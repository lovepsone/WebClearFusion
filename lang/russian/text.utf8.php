...
'modul_404'			=>'Такой страницы не существует.<br>Пожалуйста, подождите, сейчас вы будете перемещены...<br><br>',
'modul_404_link'		=>'или нажмите сюда, если не хотите ждать',
...
'menu_admin_module'		=>'Управление в модулях',
...
# тексты в навигации админки
'nw'				=>'Новости',
'fm'				=>'Форум',
'pn'				=>'Панели',
'nc'				=>'Категории новостей',
'sl'				=>'Навигация сайта',
'st'				=>'Главные установки',
'sm'				=>'Прочие установки',
'fq'				=>'FAQ',

# тексты на панелях (стандартных)
'title_menu'			=>'Меню сайта',
'title_admin'			=>'Админка',
'title_auth'			=>'Профиль',
);
?>